			...
			const mutate = async (target, on) => {
				...
				try {
					...
					if (key === activeKey.current) {
						...
						noticeSeq.current += 1;
						setNotice({
							key: on ? "refresh.hintOn" : "refresh.hintOff",
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)(_deepseek_ai_dsh_client_ui_primitives.Pill, {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconSkillOutline16, { size: 13 }),
							...
							onClick: () => setTab("mcp"),
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconCordisPluginOutline14, { size: 13 }),
						...
						children: [props.layers.length > 1 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							...
							anchor: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.Button, {
								variant: "ghost",
								size: "sm",
								icon: /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconEllipsisOutline16, { size: 16 }),
								"aria-label": t("more"),
								title: t("more"),
