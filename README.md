...
```bash
dsh plugin --profile web add github:aa2246740/dsh-skillhub#v1.0.1
```
...
[![DeepSeek Harness](https://img.shields.io/badge/DeepSeek%20Harness-0.1.5--rc.3-4F46E5?style=flat-square)](https://github.com/deepseek-ai/deepseek-harness)
...
# 或者使用 npx
npx @deepseek-ai/dsh plugin --profile web add "github:aa2246740/dsh-skillhub#v1.0.1"
```
